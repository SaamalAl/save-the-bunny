...
public class Spike {
    ...
    public Spike(Context context){
        spike[0]= BitmapFactory.decodeResource(context.getResources(),R.drawable.spikes);
        spike[1]= BitmapFactory.decodeResource(context.getResources(),R.drawable.spikes);
        spike[2]= BitmapFactory.decodeResource(context.getResources(),R.drawable.spikes);
        random=new Random();
        resetPosition();
    }
